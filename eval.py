...
def main():
    ...
    parser.add_argument('--model_path', default='D:/复试深度学习项目/pretrain_768.pth', type=str, help="模型权重路径（.pth文件）")
    parser.add_argument('--tokenizer_path', default='D:/复试深度学习项目/tokenizer_15k', type=str, help="Tokenizer路径")
